Data work where I built an end-to-end ETL pipeline in AWS and do data visualisation/analytics on Tableau, and Machine Learning on SageMaker Studio. Please view my Tableau dashboards at: https://public.tableau.com/app/profile/huynh.ngoc.tram.nguyen/viz/Frauddataset/Transactionoverviewdashboard
